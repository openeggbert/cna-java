...
public final class Rg32 implements IPackedVectorOfT<Long> {
    ...
    private static long pack(float x, float y) {
        return (PackUtils.packUNorm(65_535.0f, x)
                | (PackUtils.packUNorm(65_535.0f, y) << 16)) & 0xFFFF_FFFFL;
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof Rg32 other && equals(other);
    }
